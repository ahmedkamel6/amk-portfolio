...
export function ProjectDetailPage({
  ...
  const reelUrl = getDirectDriveUrl(project.driveUrl);
  const longFormUrl = getDirectDriveUrl(project.videoUrl) || project.videoUrl;
            ...
            <div className="mt-8 grid grid-cols-1 gap-6 md:grid-cols-3">
              {related.map((rel, i) => (
                ...
                >
                  ...
                  >
                    <div className={`relative aspect-[16/10] overflow-hidden bg-gradient-to-br ${rel.gradient}`}>
                      <div className="absolute inset-0 bg-grid opacity-20" />
