  ...
  return (
    ...
    >
      <div className="pointer-events-none absolute inset-0">
        <div
          className="absolute left-1/2 top-1/2 h-[80vh] w-[80vw] -translate-x-1/2 -translate-y-1/2 rounded-full opacity-50 blur-[120px]"
          style={{
            background: `radial-gradient(ellipse at center, color-mix(in srgb, var(--emerald-glow) 18%, transparent), transparent 70%)`,
          }}
        />
        <div
          className="absolute left-1/4 top-1/2 h-[60vh] w-[40vw] -translate-y-1/2 rounded-full opacity-30 blur-[100px]"
        ...
        >
          {meta.map((m, i) => (
            <motion.div
              ...
              className="group relative flex items-center gap-4 overflow-hidden rounded-2xl border border-[var(--border)] bg-gradient-to-b from-[#0d0f14] to-[#3a4559] p-5 backdrop-blur-xl transition-all hover:border-emerald-glow/30 hover:bg-emerald-glow/[0.03]"
            >
